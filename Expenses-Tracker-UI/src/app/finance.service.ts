...
export interface Asset { id?: number; name: string; currentValue: number; }
export interface Liability { id?: number; name: string; amount: number; }
export interface FinancialSummary { totalIncome: number; totalExpense: number; totalAssets: number; totalLiabilities: number; netWorth: number; predictedNetWorthNextMonth: number; }
